...
def edit_repositories(env, obj):
    ...
    if to_create or env.unsafe:
        ...
        if env.host is None:
            ...
            questions.append({"name": "host",
                              "description": "the host of the repository, use the first letters"
                                             " of the host name or a number from above",
        ...
        if env.annex is None:
            ...
            questions.append({"name": "annex",
                              "description": "the annex of the repository, use the first letters"
                                             " of the annex name or a number from above",
        ...
        questions.append({"name": "description",
                          "description": "description of the repository, usually only needed when there"
                                         " are multiple repositories of the same annex on the same host",
    ...
    questions.append({"name": "strict",
                      "description": "strict mode: only files which the files expression should be kept,"
    ...
    if to_create or env.unsafe:
        ...
        if env.host is None:
            ...
            questions.append({"name": "source",
                              "description": "the source of the connection, use the first letters"
                                             " of the host name or a number from above",
        ...
        questions.append({"name": "destination",
                          "description": "the destination of the connection, use the first letters"
                                         " of the host name or a number from above",
